...
\newpage 
\subsection{17. How noncoding variants lead to phenotypic variation? What do we know about the role of enhancers in Mendelian disease? What's the evidence for enhancer variation in complex disease? Do enhancer variants have small or large effects on disease phenotypes?}

\begin{define}[Enhancer]
Region of the genome associated with long-range \emph{cis}-regulation of gene expression. Composed of clusters of TF binding motifs, allowing for spatiotemporal gene regulation.
\end{define}

Genome-wide ChIP experiments of TF binding sites have revealed enhancers as long-range activators of gene expression. Enhancers are also defined by unique epigenetic marks: H3K27ac and H3K4me are correlated with active enhancer activity while H3K4me1 denotes inactive enhancers. Enhancers can act as cell-type specific activators and repressors, especially during differentiation when many genes need to be activated and deactivated at precise times.

\noindent
\textbf{Enhancers and Disease}

Any detrimental mutations in enhancers have a high chance of large phenotypic consequences due to their role in regulation of multiple genes and role in differentiation. However, many enhancers are active within a specific context, so mutations in inactive enhancers will not have an effect. Enhancers can be modular as well, and thus have a small impact on overall gene expression.

Due to the modularity and somewhat mitigated risk of mutations in enhancers, selection may not act as strongly on variants. This can allow some mutations to increase in frequency, predicted by the Common Disease Common Variant model. Alone, these small effect sized mutations pose no risk, but do act additively in some individuals to produce disease phenotypes.

Variations in enhancer regions have been attribued to Mendelian diseases. Diseases such as X-link deafness and polydactyly can be explained by mutated or missing enhancers.
